...
export default function PricingCategoryCard({ category, items }) {
  return (
    <section className="rounded-lg border border-border bg-card/85 p-6 shadow-gentle backdrop-blur-xl sm:p-8">
      <h2 className="font-heading text-xl font-extrabold sm:text-2xl">{category.name}</h2>
