...
import { LayoutDashboard, CalendarDays, ListChecks, Zap, LogOut, Menu, X, UserCircle, Kanban, Package, FileText, Sparkles, Users, Building2, Bell } from "lucide-react";
...
export default function DashboardShell({ user, children }) {
  ...
  const nav = [
    ...
    ...(user?.role === "admin" ? [{ to: "/dashboard/notifications", label: "Notifications", icon: Bell }] : []),
  ];
